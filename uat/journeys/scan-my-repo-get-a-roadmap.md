...
references:
  ...
  - https://stackoverflow.blog/2026/02/18/closing-the-developer-ai-trust-gap/ — what closes the trust gap is "attribution and traceability built into systems"; the roadmap and the level only earn Sam's name if the provenance survives a skeptic's re-check.
---
...
- Sam ends with a **level they'd stake their name on** when linking the public report, and reaches this verdict in ~2–3 minutes (vs the better part of a manual audit day).
