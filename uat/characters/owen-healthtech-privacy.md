...
- [ ] **No over-claim:** the product/docs say HIPAA-*eligible* infrastructure (Bedrock), not "HIPAA-compliant," and are clear the customer owns IAM/KMS/VPC/audit (`ARCHITECTURE.md §`, `docs/features/scanning/llm-providers.md`).
