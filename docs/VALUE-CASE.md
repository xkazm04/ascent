...
|---|---|---|---|
| Delivery analytics | LinearB, Swarmia, DX, Jellyfish, Faros | DORA/flow metrics from process data, the outcomes leaders are measured on | ascent scores *practices/AI-nativeness*, not delivery outcomes |
