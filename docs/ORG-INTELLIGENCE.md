...
**Derived** (`src/lib/analyze/index.ts`): 8 dimensions, two axes (Adoption / Rigor),
...
| **C6** | **Team rollups** | CODEOWNERS / GitHub Teams → team-level Adoption×Rigor | parse CODEOWNERS / GraphQL teams |
