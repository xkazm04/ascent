...
- **Factory.ai's Agent Readiness**: 8–9 pillars × 5 levels, 60+ binary criteria, *the same hybrid engine*
...
**What already exists:** `aiGovernedRate` (are AI-authored PRs actually reviewed, per `analyze/pulls.ts`,
...
1. **The Conformance Pack** is one signed, hash-chained bundle per quarter per org: AI-PR review coverage,
