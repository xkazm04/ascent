...
// variant (accent color triad, optional focus ring, optional explicit type-body-sm) so each call site renders
// exactly as before.
...
export const HEADER_ACTION_LINK_CLASS =
  "focus-ring rounded-lg border border-slate-700 px-3 py-1.5 type-body text-slate-300 hover:border-accent hover:text-white";
