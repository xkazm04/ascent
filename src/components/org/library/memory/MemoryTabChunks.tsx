...
export const MemoryRecallPanelChunk = dynamic(
  () => import("@/components/org/library/memory/MemoryRecallPanel").then((m) => m.MemoryRecallPanel),
  { ssr: false },
);

export const MemoryReflectPanelChunk = dynamic(
  () => import("@/components/org/library/memory/MemoryReflectPanel").then((m) => m.MemoryReflectPanel),
  { ssr: false },
);
