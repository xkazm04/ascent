...
import { MemoryPanel } from "@/components/org/library/memory/MemoryPanel";
import { MemoryCoverageStrip } from "@/components/org/library/memory/MemoryCoverageStrip";
import { MemoryRecallPanelChunk, MemoryReflectPanelChunk } from "@/components/org/library/memory/MemoryTabChunks";
...
async function MemoryLibraryData({ slug, shared }: { slug: string; shared: Promise<MemoryShared> }) {
  ...
  return (
    <div className="stagger-children space-y-6">
      ...
      <Suspense fallback={<OrgTabGap minH="min-h-[36rem]" />}>
        <MemoryLibraryData slug={slug} shared={shared} />
      </Suspense>
