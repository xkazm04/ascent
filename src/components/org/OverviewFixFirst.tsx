...
import type { FixFirstItem } from "@/components/org/fixFirst";

// The Overview's "Fix first" punch-list band (pattern proven on /delivery): up to three derived,
// triage-ordered priorities, each cell a single deep link to its evidence — the "so what do I do?"
// answer at the top of the page instead of leaving the reader to synthesize it from six sections.
// Derivation lives in fixFirst.ts (pure, unit-tested); the page passes the finished items.
