...
import { PlaybookAdoptionRow } from "@/components/org/practices/PlaybookCard.adoption";
import { PlaybookApplyBatch } from "@/components/org/practices/PlaybookApplyBatch";
...
export function PlaybookCard({
  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
      ...
      <PlaybookAdoptionRow playbook={p} slug={slug} adoption={adoption} applied={applied} />
      ...
      <PlaybookApplyBatch
        ...
        onApplied={(repos) => setApplied((a) => [...new Set([...a, ...repos])])}
      />
