...
// The Governance view moved into the org dashboard's single `?tab=` shell
...
export default async function OrgGovernanceRedirect({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
  redirect(orgTabHref(slug, "governance"));
}
