...
// The Integrations view moved into the org dashboard's single `?tab=` shell
...
export default async function OrgIntegrationsRedirect({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
  redirect(orgTabHref(slug, "integrations"));
}
