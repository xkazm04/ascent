...
// The Practices view moved into the org dashboard's single `?tab=` shell (docs/ORG-TABS-REFACTOR.md).
...
export default async function OrgPracticesRedirect({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
  redirect(orgTabHref(slug, "practices"));
}
