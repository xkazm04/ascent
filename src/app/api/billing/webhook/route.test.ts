...
const cap = vi.hoisted(() => ({ config: null as null | { onOrderPaid: (p: unknown) => Promise<void>; onOrderRefunded: (p: unknown) => Promise<void> } }));
...
function order(over: Partial<Order> = {}): Order {
  return { id: "ord1", productId: "prod_1", customer: { externalId: "acme" }, metadata: null, netAmount: 1000, totalAmount: 1000, refundedAmount: 0, ...over };
}
