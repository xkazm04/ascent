 ...
 *
 * - **Formula injection**: formula-like prefixes, including tab/CR/LF and full-width variants,
 *   receive the existing single-quote text prefix inside a quoted cell. This is an export-time
 *   mitigation, not a guarantee across spreadsheet applications or later save/reopen cycles.
 ...
 *   non-numeric dangerous prefix (e.g. `-1+cmd`, `=HYPERLINK(...)`) is guarded.
 * - **RFC-4180 quoting**: by default a field is quoted when it contains `"`, `,`, CR, or LF
