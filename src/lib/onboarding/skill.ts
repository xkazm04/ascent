...
// hardcoded fallback: this file is generated by a self-hostable AGPL build, the footer tells the
// reader to "re-scan" through that link, and an unconfigured instance was sending them to
