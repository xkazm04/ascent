// The Impact Ledger half of the ExecutiveTab suite, split out of ExecutiveTab.test.tsx for the
// 200-line cap. Same style as its sibling: call the async server-component function directly and walk
// the returned React element tree (no DOM render needed for a server component), with its own copy of
// the mock harness so each file stands alone.
//
