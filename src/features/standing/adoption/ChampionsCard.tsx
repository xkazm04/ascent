  ...
  return (
    <Card>
      <SectionHeader
        ...
        right={
          <Link href={orgTabHref(slug, "contributors")} className="shrink-0 type-label tracking-widest text-slate-500 transition hover:text-accent">
            Contributors →
          </Link>
        }
      />
      {totalContributors < CHAMPION_MIN_POP ? (
        ...
        <div className="mt-3 space-y-1.5">
          {champions.map((c) => (
            <div key={c.login} className="flex items-center gap-3 type-body-sm">
              ...
              <span className="w-28 shrink-0 text-right type-mono-sm text-slate-400">
