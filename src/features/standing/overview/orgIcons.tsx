...
export function SharedIcon({ size = 18, className }: IconProps) {
  // Planted flag — one thing staked out for everybody: the registry repo and the practices, skills and
  // memory it distributes to every repo in the fleet.
  return (
    <Svg size={size} className={className}>
      <path d="M5.5 21V3.5" />
