...
export function SegmentComparePicker({ options, a, b }: { options: Opt[]; a: string; b: string | null }) {
  ...
  const selectCls =
    "rounded-lg border border-slate-700 bg-slate-900 px-2.5 py-1.5 type-mono-sm text-slate-200 focus:border-accent focus:outline-none";
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <span className="type-mono-sm text-slate-500">vs</span>
