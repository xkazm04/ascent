...
//     App cannot perform.
//
// The per-dimension floors beyond D9 have their own sibling file, GatePolicyEditor.floors.test.tsx
// (200-LOC cap); the setup below is duplicated there deliberately so each file stands alone.
