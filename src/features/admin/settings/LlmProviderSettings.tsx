    ...
    <Card>
      ...
      <div className="mt-4 space-y-3" aria-disabled={disabledAll}>
        <label className="block">
          <span className="type-mono-sm text-slate-500">Model ID</span>
          <input
            value={f.modelId}
            onChange={(e) => f.setModelId(e.target.value)}
            disabled={disabledAll}
            placeholder={DEFAULT_MODEL}
            className="mt-1 w-full rounded-lg border border-slate-700 bg-slate-900 px-2.5 py-1.5 type-mono-sm text-slate-200 placeholder:text-slate-600 disabled:opacity-50"
          />
        </label>
        <label className="block">
          <span className="type-mono-sm text-slate-500">Region</span>
          <input
            value={f.region}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <label className="block">
            <span className="type-mono-sm text-slate-500">AWS Access Key ID</span>
            <input
              value={f.accessKeyId}
          ...
          <label className="block">
            <span className="type-mono-sm text-slate-500">AWS Secret Access Key</span>
            <input
              type="password"
        ...
        {f.blockedBySwitch && (
          <p className="rounded-lg border border-orange-500/30 bg-orange-500/5 p-3 type-body-sm text-orange-200">
