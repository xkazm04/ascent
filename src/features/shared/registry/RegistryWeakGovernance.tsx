        ...
        >
          {rows.map((r) => (
            <tr key={r.repoFullName}>
              <td className="px-4 py-2 type-mono-sm text-slate-300">{r.repoFullName}</td>
              <td className="px-4 py-2 text-right type-mono-sm tabular-nums text-slate-200">{r.weak}</td>
              <td className="px-4 py-2 text-right type-mono-sm tabular-nums text-slate-500">{r.contexts}</td>
              <td className="px-4 py-2 text-right type-mono-sm tabular-nums text-slate-400">{r.share}%</td>
            </tr>
          ))}
        </OrgTable>
      )}
