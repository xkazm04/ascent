// Shared markup for the scan-ledger scene's regions. No hooks, no "use client": a Region is the
...
export const TD = "border-t border-divider py-1.5 pr-3 align-middle";
