...
export function Playground({
  ...
  const [notes, setNotes] = useState(Boolean(technique));
      ...
      {subject.interactive && subject.record ? (
        <>
          ...
          <div className={styles.belowStage}>
            ...
            <Link href={knowledgeHref}>Read knowledge reference ↗</Link>
          </div>
          <section className={styles.notes}>
            ...
            >
              <span>
                ...
                <small>{subject.record.techniqueSlugs.length} reference techniques</small>
              </span>
              <span>{notes ? "−" : "+"}</span>
            </button>
            {notes && (
              <div id="kb-reference">
                <ReferenceNotes record={subject.record} selected={technique} knowledgeHref={knowledgeHref} />
              </div>
            )}
          </section>
