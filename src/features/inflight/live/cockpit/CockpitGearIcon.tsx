...
// reason to take one on. Decorative — the button around it holds the accessible name. Extracted from
// CockpitHeader (pure relocation) when the masthead took the Live view switch. No hooks, no handlers,
// so no "use client": it renders inside the header, which already is one.
