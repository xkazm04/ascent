...
export const HEADLINE_SCALE: Record<WallScale, HeadlineScaleTokens> = {
  panel: {
    pad: "p-4 lg:p-5",
    label: "type-mono-sm",
    value: "type-figure-lg sm:type-display-lg",
    glyph: "type-body",
    delta: "type-mono-sm",
    sub: "type-mono-sm",
    spark: { w: 112, h: 28 },
  ...
  wall: {
    pad: "p-6 xl:p-8",
    label: "type-body xl:type-title",
    value: "text-5xl sm:text-6xl xl:text-7xl",
    glyph: "type-figure xl:type-display-lg",
    delta: "type-body xl:type-lede",
    sub: "type-body xl:type-lede",
    spark: { w: 176, h: 44 },
  },
};
