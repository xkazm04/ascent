...
// The per-cell fold lives beside this module (extracted at the 200-line cap); its two types are
// re-exported below so no call site had to move.
import { foldCell, type OutcomeCell, type OutcomeDim } from "./outcomeCellFold";
import { runAttribution } from "../cockpit/cockpitDrift";
import { deliveryTag, isRunLive, type LoopLaneOutcome, type LoopRunDetail, type LoopRunPhase } from "../cockpit/loopTypes";

export type { OutcomeCell, OutcomeDim };
