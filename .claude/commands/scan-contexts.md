...
Analyze the **ascent** codebase at **C:\Users\kazda\kiro\ascent** and create/update intelligent, structure-based contexts in the SQLite database.

## Project Information

- **Project ID**: 847cd027-0e92-434d-914d-d94463e00895
- **Project Name**: ascent
- **Project Path**: C:\Users\kazda\kiro\ascent
- **Project Type**: nextjs
- **Scan Timestamp**: 2026-05-30T12-15-23
...
- `PROJECT_ID` → 847cd027-0e92-434d-914d-d94463e00895
- `PROJECT_PATH` → C:\Users\kazda\kiro\ascent
...
```bash
curl -X GET "http://localhost:3000/api/contexts?projectId=847cd027-0e92-434d-914d-d94463e00895"
```
...
find "C:\Users\kazda\kiro\ascent/src/app" -maxdepth 1 -type d -name "*-page" 2>/dev/null
find "C:\Users\kazda\kiro\ascent/src/app/features" -maxdepth 1 -type d -name "sub_*" 2>/dev/null
```

### 3. Read High-Level Architecture (Optional)

```bash
cat "C:\Users\kazda\kiro\ascent/context/high.md" 2>/dev/null || echo "No high-level architecture file found"
```
...
mkdir -p "C:\Users\kazda\kiro\ascent/docs/contexts"

# Generate the report
cat > "C:\Users\kazda\kiro\ascent/docs/contexts/scan-report-2026-05-30T12-15-23.md" << 'EOF'
# Context Scan Report
...
C:\Users\kazda\kiro\ascent/docs/contexts/scan-report-2026-05-30T12-15-23.md
